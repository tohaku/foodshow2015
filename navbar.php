...
<head>
    ...
    <script>
        ...
        function registerBooth(boothID){
            ...
            var tempVar = boothsArray.length;
            //var tempProblemSolver = boothsArray.slice(1,tempVar);
            document.getElementById('boothNumbers').value = boothsArray.slice(1,tempVar);
        }
...
<div class = "header" style="background-color:<?php if($section=='school'){echo '#B39DDB';}elseif($section=='vendor'){echo '#00BFA5';}elseif($section=='directions'){echo '#FFCC80';}?>;">
    <span id="pageTitle"><a href="index.php"><img src="pics/gsfLogo.png">Slic COOP Food Show 2016 </img></a></span><br><span id="broughtToYou">Brought to you by Goldstar Norcal</span>
    <ul class="nav">
